...
azure vm create --resource-group adatumlabrg --name ResDevDB2 --image-urn Win2012R2Datacenter --os-disk-vhd OSDisk.vhd --location westeurope --vm-size Standard_A4 --storage-account-name adatumlabrg1sa1 --os-type Windows --vnet-name HQ --vnet-subnet-name Subnet1 --nic-name resdevdb2-ext --public-ip-allocation-method Dynamic -u Student -p Pa$$w0rd1234!
